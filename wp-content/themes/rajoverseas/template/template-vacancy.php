...
<?php $breadcrumbImage = get_theme_mod('breadcrumb_settings'); ?>
   ...
   <div class="container aos-init aos-animate" data-aos="fade-up">
      <div class="row">  
            ...
            <div class="col-lg-12 aos-init aos-animate" data-aos="fade-left" data-aos-delay="140">
               ...
               <?php 
                ...
                <div class="icon-box mt-5 mt-lg-0 aos-init py-2" data-aos="zoom-in" data-aos-delay="140">
                  <?php $image = get_field('job_image'); ?>
                   ...
                   <?php endif; ?>
                  <h4><a href="<?php the_permalink(); ?>" style="color:#179b49;"> 
         ...
         <input type="hidden" name="id" id="id">
          <div class="modal-body">
           ...
           <div class="row">
              ...
              <div class="col-md-6 form-group mt-3">
                <label for="">DOB</label>
                 <input min="<?php echo date('Y-m-d')?>" type="date" class="form-control" name="dob" id="dob" placeholder="Date of birth" required>
              </div>
